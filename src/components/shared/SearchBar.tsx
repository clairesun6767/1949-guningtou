...
async function loadData() {
  ...
  try {
    ...
    const links = [
      ...
      { type: '頁面', title: '戰後影響', href: '/1949-guningtou/zh-tw/aftermath/' },
      { type: '頁面', title: '四日時間軸', href: '/1949-guningtou/zh-tw/timeline/' },
      { type: '頁面', title: '戰役地圖', href: '/1949-guningtou/zh-tw/map/' },
      { type: '頁面', title: '戰役故事', href: '/1949-guningtou/zh-tw/stories/' },
      { type: '頁面', title: '人物', href: '/1949-guningtou/zh-tw/figures/' },
      { type: '頁面', title: '地點', href: '/1949-guningtou/zh-tw/locations/' },
      { type: '頁面', title: '武器', href: '/1949-guningtou/zh-tw/weapons/' },
      { type: '頁面', title: '文物', href: '/1949-guningtou/zh-tw/artifacts/' },
      { type: '頁面', title: '多元觀點', href: '/1949-guningtou/zh-tw/perspectives/' },
      { type: '頁面', title: '文獻資料庫', href: '/1949-guningtou/zh-tw/sources/' },
      { type: '頁面', title: '數位典藏', href: '/1949-guningtou/zh-tw/archive/' },
    ...
    const terms = [
      ...
      { type: '人物', title: '熊震球', href: '/1949-guningtou/zh-tw/figures/', subtitle: '戰車射手' },
      { type: '人物', title: '胡璉', href: '/1949-guningtou/zh-tw/figures/', subtitle: '金防部司令' },
      { type: '人物', title: '葉飛', href: '/1949-guningtou/zh-tw/figures/', subtitle: '第十兵團司令' },
      { type: '武器', title: 'M5A1 輕戰車', href: '/1949-guningtou/zh-tw/weapons/', subtitle: '66號車' },
      { type: '事件', title: '第一砲', href: '/1949-guningtou/zh-tw/timeline/', subtitle: '1949-10-25 00:30' },
